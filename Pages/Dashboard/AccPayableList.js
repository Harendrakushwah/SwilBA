...
const AccPayableList = ({navigation}) => {
        ...
        <FlatList
          ...
          renderItem={({item: cust}) => (
            <View style={{...styles.cardRow, flex: 1}}>
              <TouchableOpacity
                onPress={() => {
                  dispatch(CommonSliceActions.setCustomerPayableData(null))
                  navigation.navigate('accountsStack', {screen : "accpayorderview", params : {data: cust}})
                }
                }
              >
